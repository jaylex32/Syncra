...
from PyQt5.QtWidgets import (QApplication, QMainWindow, QWidget, QVBoxLayout, QHBoxLayout, 
                             ...
                             QCheckBox, QListWidgetItem, QTabWidget, QProgressBar, 
                             QMessageBox, QComboBox, QFrame, QScrollArea, QSpacerItem,
                             QSizePolicy, QStackedWidget, QGroupBox, QDialog)
...
class PlexPlaylistManager(QMainWindow):
    def __init__(self):
        ...
        self.setWindowTitle('Plex Playlist Dock')
        self.setWindowIcon(QIcon('plex-logo.png'))
    ...
    def initUI(self):
        ...
        logo_label = QLabel()
        logo_pixmap = QPixmap(resource_path('plex-logo.png')).scaled(200, 200, Qt.KeepAspectRatio, Qt.SmoothTransformation)
